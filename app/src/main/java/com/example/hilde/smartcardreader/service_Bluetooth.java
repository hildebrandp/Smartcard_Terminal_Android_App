...
public class service_Bluetooth {
    // Debugging
    private static final String TAG = "SCR_BT_Service";
    private static final boolean D = true;

    // Name for the SDP record when creating server socket
    private static final String NAME = "service_Bluetooth";
     ...
     */
    public service_Bluetooth(Context context, Handler handler) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                service_Bluetooth.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (service_Bluetooth.this) {
                mConnectThread = null;
            }
